...
function Introduc() {
  ...
  return (
    <div className='flex mb-10 md:mb-0  w-[90%] md:sticky md:top-[100px] gap-6 md:w-[50%] text-white flex-col'>
      ...
      <a href="/public/Saviour_Samuel_CV_Expanded.docx" download className="inline-block w-max px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">
  Download My CV
</a>
      ...
      <Link href="https://x.com/home">  <FaXTwitter className='cursor-pointer hover:text-blue-200 transition-all' size={24} /></Link>  
       <Link href='jj'>  <FaLinkedin className='cursor-pointer hover:text-blue-200 transition-all' size={24} arial-label='linkedin' /></Link>
        <Link href='https://www.instagram.com/'><FaInstagram className='cursor-pointer hover:text-blue-200 transition-all' size={24} /></Link >
        <Link href='https://github.com/SAVDEV-TECH/'><FaGithub className='cursor-pointer hover:text-blue-200 transition-all' size={24} />
        </Link> 
        </span> 
